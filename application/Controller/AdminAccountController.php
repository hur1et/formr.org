            ...
            if ($this->request->getParam('save_ai_settings') !== null) {
                if (!$this->user->isAdmin()) {
                    ...
                    $aiConfig = array(
                        ...
                        'min_turns'         => max(0,  (int) $this->request->getParam('ai_min_turns', 3)),
                        'max_turns'         => max(0,  (int) $this->request->getParam('ai_max_turns', 0)),
                        'min_words'         => max(0,  (int) $this->request->getParam('ai_min_words', 0)),
                        'max_words'         => max(0,  (int) $this->request->getParam('ai_max_words', 0)),
